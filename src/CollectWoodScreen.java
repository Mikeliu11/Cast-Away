...
public class CollectWoodScreen extends BaseScreen{
	...
	public CollectWoodScreen(Game game) {
		super(game);
	}

	public void createGameLogic()
	{		
		// -- Randomize number of wood collected
		int woodAmount = (int) ( Math.random() * 3 * GameState.getToolLevel() ) + 1;
		GameState.entity.add( 1, 3, woodAmount );
		// -- Add 2 hours to time
		GameState.timePass( 2 );
		message = "You collected " + woodAmount + "\nwood in 2 hours.\n";
	}
	...
	public void create() {
		...
		// -- Title
		title = new BaseActor();
		title.setTexture( new Texture( Gdx.files.internal("assets/title_wood.png")));
